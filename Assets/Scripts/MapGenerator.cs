...
public class MapGenerator : MonoBehaviour {
	...
	void ProcessMap () {
		...
		int wallThresholdSize = WALL_THRESHOLD_SIZE;
		...
		int roomThresholdSize = ROOM_THRESHOLD_SIZE;
	...
	void ConnectClosestRooms (List<Room> allRooms, bool forceAccessibilityFromMainRoom = FORCE_ACCESS) {
